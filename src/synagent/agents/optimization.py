...
from ..pubchem import get_hazard_summaries_batch
...
Your job is to:
1. Accept SMILES strings for compounds in a synthetic route.
2. Look up hazard information from PubChem for each compound.
3. Compute compound-level hazard scores using the provided scoring function.
4. Compute the overall route hazard score.
5. Explain the result clearly, including any red flags.
